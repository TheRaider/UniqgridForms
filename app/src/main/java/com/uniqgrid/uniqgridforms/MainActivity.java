...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fabAddForm = (FloatingActionButton) findViewById(R.id.fabAddForm);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_forms) {
            MyFormsFragment myFormsFragment  = new MyFormsFragment();
            transaction.replace(R.id.fragment_container, myFormsFragment);
            transaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE);
            transaction.commit();
        } else if (id == R.id.nav_drafts) {
            SavedFormsFragment savedFormsFragment = new SavedFormsFragment();
            transaction.replace(R.id.fragment_container, savedFormsFragment);
            transaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE);
            transaction.commit();
